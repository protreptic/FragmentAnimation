...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    * */
    ...
    RoundRectDrawableWithShadow(Resources resources, int backgroundColor, float radius,
        ...
        mShadowStartColor = resources.getColor(R.color.checkview_shadow_start_color);
        mShadowEndColor = resources.getColor(R.color.checkview_shadow_end_color);
